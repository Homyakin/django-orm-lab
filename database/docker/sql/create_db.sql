...
CREATE TABLE IF NOT EXISTS `storage`.`product_to_rack` (
  ...
  `product_contract_number` INT NOT NULL,
  `position` VARCHAR(45) NOT NULL,
  INDEX `fk_table1_rack1_idx` (`rack_number` ASC) VISIBLE,
  INDEX `fk_table1_product1_idx` (`product_contract_number` ASC) VISIBLE,
  PRIMARY KEY (`rack_number`, `product_contract_number`),
  ...
  CONSTRAINT `fk_table1_product1`
    FOREIGN KEY (`product_contract_number`)
